...
const CarouselItem=(props)=>{
  const {id,cover,title,year,contentRating,duration} = props; //ootra manera de pasar propiedades como parametros
                ...
                <div className="carousel-item__details">
                  <div>
                    ...
                    <img className="carousel-item__details--img"
                     ...
                     <img className="carousel-item__details--img"
                     src={removeIcon} alt="Remove-icon" onClick={()=> handleDeleteFavorite(id)}/>
                  </div>
